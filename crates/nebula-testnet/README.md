...
reward-account count, reward-ledger root, operational-evidence root, and the
genesis fee token identities. It also rejects validator consensus/network keys
