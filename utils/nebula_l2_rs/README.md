...
for failed capture/preflight/package file-set/runbook receipt/status/bootstrap topology and policy bindings, bootstrap operator-registry/signature, node-probe, P2P endpoint-set, status-page endpoint-set, and live-probe leaf repair roots, deferred
