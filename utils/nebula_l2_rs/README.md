...
for failed capture/preflight/package file-set/runbook receipt/status/bootstrap topology and policy bindings, bootstrap operator-registry/signature, node-probe, P2P endpoint-set, status-page endpoint-set, live-probe leaf, evidence/provenance, and package-identity repair roots, deferred
