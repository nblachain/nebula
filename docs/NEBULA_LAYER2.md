...
- A dedicated public launch gate fails until local public-alpha surfaces,
  ...
  subchecks, root-specific `repair_roots` for failed capture/package/runbook/
  status/bootstrap policy bindings, and capture roots, bootstrap profile/report/rate-limit roots,
